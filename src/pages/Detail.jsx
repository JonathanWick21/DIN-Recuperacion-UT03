      ...
      <main className="container mx-auto px-4 py-10 min-h-screen">
        ...
        <article className="bg-white rounded-2xl shadow-xl overflow-hidden border border-slate-200 md:flex">
          ...
          <div className="p-8 md:p-12 md:w-3/5 flex flex-col justify-center">
            <div className="flex items-center gap-3 mb-2" tabIndex="0" aria-label={`Mundo: ${character.mundo}, Tipo: ${character.tipo}`}>
            ...
            <h1 className="text-4xl md:text-5xl font-serif font-bold text-slate-900 mb-6" tabIndex="0">
              {character.nombre}
            </h1>

            <div className="space-y-4 mb-8">
              <h3 className="text-xl font-bold text-slate-800 border-b border-slate-200 pb-2" tabIndex="0">
                Archivos Históricos
              </h3>
            ...
            <div className="mt-auto inline-block bg-amber-100 text-amber-900 px-6 py-3 rounded-lg font-mono font-bold text-lg w-fit border border-amber-200" tabIndex="0">
